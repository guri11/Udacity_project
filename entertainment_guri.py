...
kingsman_the_golden_circle = media.Movie('KINGSMAN: THE GOLDEN CIRCLE',
                              '"Kingsman: The Secret Service" introduced the world to Kingsman - an independent, international intelligence agency operating at the highest level of discretion, whose ultimate goal is to keep the world safe. In "Kingsman: The Golden Circle," our heroes face a new challenge. When their headquarters are destroyed and the world is held hostage, their journey leads them to the discovery of an allied spy organization in the US called Statesman, dating back to the day they were both founded. In a new adventure that tests their agents strength and wits to the limit, these two elite secret organizations band together to defeat a ruthless common enemy, in order to save the world, something that is becoming a bit of a habit for Eggsy...',
...
the_Lego_Batman_Movie = media.Movie('The LEGO Batman Movie',
                                 'There are big changes brewing in Gotham City, and if he wants to save the city from The Jokers hostile takeover, Batman may have to drop the lone vigilante thing, try to work with others and maybe, just maybe, learn to lighten up.',
                                 'https://upload.wikimedia.org/wikipedia/en/6/61/The_Lego_Batman_Movie_PromotionalPoster.jpg',
                                 'https://www.youtube.com/watch?v=HbwrGI_NbfY')

movies = [alien_Covenant, catch_me_if_you_can, it, kingsman_the_golden_circle, the_man_who_knew_infinity, the_Lego_Batman_Movie]
